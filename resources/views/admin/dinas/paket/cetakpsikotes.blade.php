...
<body>
	...
	<center>
		<img src="{!!$logo!!}" width="80" alt="">
                ...
                <h6>Hasil Rekap {{ $paket->nama_paket }} - Psikotes</h6>
	</center>
        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;">Verbal</th>
                    <th style="text-align: center;">Numerik</th>
                    <th style="text-align: center;">Figural</th>
              ...
              <tbody>
                ...
                @foreach ($hasil as $item)
                    <tr>
                        ...
                        <td>{{$item->nama}}</td>
                        <td>{{ $item->kelas }}</td>
                        <td style="text-align: center;">{{$item->verbal}}</td>
                        <td style="text-align: center;">{{$item->numerik}}</td>
                        <td style="text-align: center;">{{$item->figural}}</td>
