        ...
        <table>
                ...
                <tr>
                    ...
                    <td class="pl-4 pb-4">
                        ...
                        <ol type="A">
                            <li>{!!$item->opsi_a!!} (Poin: {{ $item->poin_a }})</li>
                            <li>{!!$item->opsi_b!!} (Poin: {{ $item->poin_b }})</li>
                            <li>{!!$item->opsi_c!!} (Poin: {{ $item->poin_c }})</li>
                            <li>{!!$item->opsi_d!!} (Poin: {{ $item->poin_d }})</li>
                            @if (isset($item->opsi_e))
                            <li>{!!$item->opsi_e!!} (Poin: {{ $item->poin_e }})</li>
                            @endif
                        </ol>
                    </td>
                </tr>
