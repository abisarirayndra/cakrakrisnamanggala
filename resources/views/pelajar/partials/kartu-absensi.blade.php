    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content ck-card">
            ...
            <div class="modal-body">
                <article class="ck-id-card mx-auto">
                    <header class="ck-id-card-head">
                        ...
                        <p class="mb-0 small opacity-75">Kartu Absensi Pelajar</p>
                    </header>
                    <div class="ck-id-card-body">
                        ...
                        <div class="ck-id-card-meta">
                            ...
                            <p class="ck-hint mb-1">Kelas</p>
                            <p class="fw-semibold mb-3">{{ $kelasNama ?: '—' }}</p>
            ...
            <div class="modal-footer border-0 pt-0">
                @if ($nomor_registrasi)
                    <a href="{{ route('pelajar.kartu-absensi') }}" class="btn btn-ck">
