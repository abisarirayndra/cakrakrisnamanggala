...
@section('content')
    <div class="mb-4">
        ...
        <p class="ck-hint mb-0">Paket-paket yang disiapkan oleh pendidik untuk Computer Assisted Test.</p>
    </div>
            ...
            @forelse ($paket as $item)
                <div class="col-md-6 col-xl-4">
                    <section class="ck-card p-4 h-100">
                        ...
                        <a href="{{ route('pelajar.dinas.tes', [$item->id]) }}" class="btn btn-sm btn-ck">Buka</a>
                    </section>
                </div>
            @empty
                <div class="col-12">
                    <p class="ck-hint mb-0">Belum ada paket soal untuk kelas Anda.</p>
                </div>
            @endforelse
        </div>
    </section>
