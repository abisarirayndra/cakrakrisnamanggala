...
<body>
  <div id="app">
    <div class="main-wrapper">
      <div class="navbar-bg-pelajar"></div>
      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu mt-4">
              ...
              <li class="active"><a class="nav-link" href="blank.html"><i class="far fa-square"></i> <span>Beranda</span></a></li>
              <li class="nav-item dropdown">
                    ...
                    <table class="table table-bordered" id="table-1">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>
                                <a href="{{route('pelajar.cat.tema', [$item->id])}}"><button type="button" class="btn btn-sm btn-success">Kerjakan</button></a>
                              </td>
                            </tr>
                          @endforeach
                      </tbody>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="{{route('pengajar.cat.tambahpaket')}}">
                @csrf
                <div class="row">
                  <div class="form-group col-12">
                    <label for="nama">Nama Paket</label>
                    <input id="nama" type="text" class="form-control" name="nama_paket" autofocus required>
                  </div>
                </div>

                <div class="form-group">
                  <label for="kelas">Kelas</label>
                    <select id="" class="form-control" name="kelas_id" required>
