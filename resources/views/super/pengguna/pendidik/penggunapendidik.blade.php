...
<div class="container">
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <h5><i class="fas fa-hashtag text-warning"></i> Daftar Pengguna Pendidik</h5>
            <div class="p-3 mt-3">
                <div class="row mb-3">
                    <button type="button" class="btn btn-sm btn-warning mr-3" data-toggle="modal" data-target="#tambahpendidik">
                        <i class="fas fa-file-archive"></i> Tambah Pendidik
                    </button>
                </div>
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                            ...
                            <td>
                              ...
                              <a href="{{ route('super.penggunapendidik.hapus', [$item->id]) }}" onclick="return confirm('Anda yakin ingin menghapus akun ini ?')" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
                            </td>
                          </tr>
                        @endforeach
                    </tbody>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title text-warning" id="exampleModalLabel">Tambah Pendidik</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
                <form action="{{ route('super.penggunapendidik.tambah') }}" method="POST">
                    @csrf
