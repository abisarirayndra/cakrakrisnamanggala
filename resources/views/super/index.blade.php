      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu mt-4">
              ...
              <li class="active"><a class="nav-link" href="blank.html"><i class="far fa-square"></i> <span>Akun Pengajar</span></a></li>
              <li class="nav-item dropdown">
              ...
              <div class="card">
                <div class="row">
                  <div class="card-header">
                    <div class="col-xl-6">
                      <h4>Data Pengguna Akun Pengajar</h4>
                    </div>
                    <div class="col-xl-6">
                      <button type="button" class="btn btn-sm btn-primary float-right" data-toggle="modal" data-target="#myModal">Tambah Pengajar</button>
                    </div>
                  </div>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-striped" id="table-1">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-sm btn-success" data-toggle="modal" data-target="#">edit</button>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="POST" action="{{route('super.tambahpengajar')}}">
                @csrf
                <div class="row">
