...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
                <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="{{asset('assets/img/icon.png')}}" alt="" />Cakra Krisna Manggala</a>
            ...
            <div id="demo" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <img src="{{asset('assets/img/header-bg.jpg')}}" alt="Los Angeles" width="1100" height="500">
                  </div>
                  <div class="carousel-item">
                    <img src="{{asset('assets/img/header-sma.jpg')}}" alt="Chicago" width="1100" height="500">
                  </div>
                  <div class="carousel-item">
                    <img src="{{asset('assets/img/header-smp.jpg')}}" alt="New York" width="1100" height="500">
                  </div>
                </div>
        ...
        <section class="page-section bg-dark" id="info">
            ...
            <div class="container">
                <div class="text-left">
                    <h2 class="section-heading text-uppercase mt--2 text-light">Informasi Terkini</h2>
